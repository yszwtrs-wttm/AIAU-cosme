...
# pHash(DCT) は 16 進 16 文字（64bit）。a と b は同じ写真をリサイズした想定で
# ハミング距離 2（閾値内 = 使い回し判定）、c は別の写真で距離が離れている。
SAKURA_REVIEWS = [
    ("pr_account_a", 5, "本当に神コスメすぎる！朝塗ったら夜まで崩れない！みんな買って！ #pr", "f0e1c3878f1e3c78"),
    ("pr_account_b", 5, "まじで神コスメすぎる！朝塗ったら夜まで崩れないです！みんな買うべき！", "f0e1c38f8f1e3c7a"),
    ("pr_account_c", 5, "神コスメすぎました！朝塗って夜まで崩れない！絶対買って！", "0f1e3c78f0e1c387"),
