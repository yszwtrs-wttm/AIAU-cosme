...
商品を探す・商品ページ・色から探す・口コミの閲覧はログイン不要。手持ち登録（ポーチ）・メイク提案・口コミ投稿は本アカウントが必要なので、次のテストユーザーでログインして試せる。

| メールアドレス | パスワード |
| --- | --- |
| `kawanai.test1@example.com` | `kawanai-test-2026` |

ローカルで動かす場合は [セットアップ](#セットアップ)。
