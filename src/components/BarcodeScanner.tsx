        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          >
            <input
              ...
              className="w-56 rounded-lg border border-brand-100 px-4 py-2.5 text-sm outline-none focus:border-brand-300"
            />
            <button
              type="submit"
              className="flex items-center gap-1 rounded-full border border-brand-200 bg-ink-0 px-3 py-2.5 text-sm"
            >
              <Search size={14} /> 探す
            </button>
          </form>
            ...
            {candidates.map((p) => (
              ...
              >
                ...
                <span className="min-w-0">
                  ...
                  <span className="font-mono text-xs text-ink-500">¥{p.price_yen.toLocaleString()}</span>
                </span>
              </button>
            ))}
          </div>
