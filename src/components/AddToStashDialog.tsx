...
const TAB_ON = "bg-ink-900 text-ink-0";
  ...
  return (
    <>
      <button
        ...
        className="flex shrink-0 items-center gap-1.5 rounded-full bg-brand-600 px-4 py-2.5 text-sm font-bold text-ink-0"
      >
        <Plus size={16} /> 商品を追加
      </button>
      ...
      {open && (
        ...
        >
          <div
            ...
            className="flex max-h-[90vh] w-full flex-col overflow-hidden rounded-t-xl bg-ink-0 sm:max-w-2xl sm:rounded-xl"
          >
